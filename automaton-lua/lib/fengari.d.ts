 ...
 * Originally from https://raw.githubusercontent.com/roddypratt/fengari/d26e8af251b2d5ac6ff681672664af43b117af2a/typings/fengari.d.ts
 */
...
export namespace lua {
  ...
  function lua_resume(L: lua_State, from: lua_State | null, nargs: number): number;
  function lua_rotate(L: lua_State, idx: number, n: number): void;

  function lua_setallocf(L: lua_State, f: lua_Alloc, ud: any): void;
  function lua_setfield(L: lua_State, index: number, s: lua_String | string): void;
  function lua_setglobal(L: lua_State, name: lua_String | string): void;
  ...
  function lua_typename(L: lua_State, tp: lua_Type): Uint8Array;
  ...
  function lua_toproxy(L: lua_State, index: number): (L: lua_State) => void;

  function lua_setupvalue(L: lua_State, funcIndex: number, number: number): null;
}
...
export namespace lauxlib {
  ...
  function luaL_checkstring(L: lua.lua_State, narg: number): Uint8Array;
  ...
  function luaL_checkudata(L: lua.lua_State, narg: number, tname: string): unknown;
  ...
  function luaL_error(L: lua.lua_State, fmt: lua_String | string, ...args: any[]): number;
  ...
  function luaL_traceback(L: lua.lua_State, L2: lua.lua_State, msg: lua_String | string, level: number): void;
}
